            ...
            >
              <div class="flex flex-col">
                <input
                  ...
                  class="w-100 mt-2 py-2 px-3 rounded-lg bg-gray-200 border-gray-50 text-black"
                ></input>
              </div>
              <div class="flex flex-col">
                <input
              ...
              <div class="flex flex-col">
                <textarea
                  ...
                  class=" w-100  h-24 mt-2 py-2 px-3 rounded-lg bg-gray-200 border-gray-50 text-black"
                ></textarea>
              </div>
