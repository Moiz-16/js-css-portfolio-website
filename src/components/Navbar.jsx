...
const Navbar = () => {
  ...
  return (
    <div className="z-10 text-black flex justify-between items-center max-w-[1240px] mx-auto h-24 px-6 text-l">
      <h1 className="list-nonefont text-3xl font-bold primary-color ml-4">
        moizsaleem.io
      </h1>
      ...
      <div
        className={
          nav
            ? "bg-white black fixed h-full left-0 top-0 w-[60%] border-r border-r-gray-200  ease-in-out duration-500"
            : "fixed left-[-100%]"
        }
      >
        <h1 className="list-nonefont text-3xl font-bold primary-color m-4">
          moizsaleem.io
        </h1>
